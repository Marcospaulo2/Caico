...
<head>
    ...
    <link rel="shortcut icon" href="/img/favicon-ingressos-caico.png" type="image/x-icon">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-uWxY/CJNBR+1zjPWmfnSnVxwRheevXITnMqoEIeG1LJrdI0GlVs/9cVSyPYXdcSF" crossorigin="anonymous">
    <title>Festa de Santana</title>
...
<body>
            ...
            <div class="nav-container">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><img src="img/favicon-ingressos-caico (1).png" width="40%"></h5>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a target="_black" href="https://www.instagram.com/festadesantanacaico2023/?igshid=NTc4MTIwNjQ2YQ%3D%3D"><img src="img/eYx8cP.tif.png"></a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="banner">
        <img src="img/FESTA DE SANTANA.png">
        <!-- <div class="banner-icon">
            <img src="./img/Grupo4.png">
        </div> -->
    </div>
    <div class="comprar-btn">
        <a target="_blanck" href="https://www.evenyx.com/festa-de-santana-de-caico">
            <button class="form-button">COMPRAR INGRESSO    
            </button>
        </a>
    </div>

    <img width="100%" src="img/caico-footer.png 
    " alt="" srcset="">
